...
/**
 * ODS export handler: embeds the chart as a high-resolution PNG.
 */
public class ChartElementOdsHandler implements GenericElementOdsHandler
{
	private static final ChartElementOdsHandler INSTANCE = new ChartElementOdsHandler();

	public static ChartElementOdsHandler getInstance()
	{
		return INSTANCE;
	}
		...
		JRGridLayout layout)
	{
		try
		{
			...
			exporter.exportImage(image, gridCell, colIndex, rowIndex, emptyCols, yCutsRow, layout);
		}
		catch (Exception e)
		{
